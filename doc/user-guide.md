...
The following table lists configurable parameters of the `AppsodyApplication` CRD. For complete OpenAPI v3 representation of these values please see [`AppsodyApplication` CRD](https://github.com/appsody/appsody-operator/blob/master/deploy/crds/appsody_v1beta1_appsodyapplication_crd.yaml#L58).
