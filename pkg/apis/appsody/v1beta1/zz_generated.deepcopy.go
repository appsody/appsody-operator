	...
	if in.Consumers != nil {
		...
		*out = make([]*AppsodyApplicationServiceConsumer, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AppsodyApplicationServiceConsumer)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppsodyApplicationServiceConsumer) DeepCopyInto(out *AppsodyApplicationServiceConsumer) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppsodyApplicationServiceConsumer.
func (in *AppsodyApplicationServiceConsumer) DeepCopy() *AppsodyApplicationServiceConsumer {
	if in == nil {
		return nil
	}
	out := new(AppsodyApplicationServiceConsumer)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppsodyApplicationServiceProvider) DeepCopyInto(out *AppsodyApplicationServiceProvider) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppsodyApplicationServiceProvider.
func (in *AppsodyApplicationServiceProvider) DeepCopy() *AppsodyApplicationServiceProvider {
	if in == nil {
		return nil
	}
	out := new(AppsodyApplicationServiceProvider)
