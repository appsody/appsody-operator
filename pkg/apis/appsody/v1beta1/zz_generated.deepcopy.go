...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppsodyApplicationDefinition) DeepCopyInto(out *AppsodyApplicationDefinition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppsodyApplicationDefinition.
func (in *AppsodyApplicationDefinition) DeepCopy() *AppsodyApplicationDefinition {
	if in == nil {
		return nil
	}
	out := new(AppsodyApplicationDefinition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AppsodyApplicationSpec) DeepCopyInto(out *AppsodyApplicationSpec) {
	*out = *in
	...
	if in.AppDefinition != nil {
		in, out := &in.AppDefinition, &out.AppDefinition
		*out = new(AppsodyApplicationDefinition)
		(*in).DeepCopyInto(*out)
	}
	return
