...
func (in *AppsodyApplicationStatus) DeepCopyInto(out *AppsodyApplicationStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]AppsodyApplicationStatusCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppsodyApplicationStatusCondition) DeepCopyInto(out *AppsodyApplicationStatusCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppsodyApplicationStatusCondition.
func (in *AppsodyApplicationStatusCondition) DeepCopy() *AppsodyApplicationStatusCondition {
	if in == nil {
		return nil
	}
	out := new(AppsodyApplicationStatusCondition)
	in.DeepCopyInto(out)
	return out
}
