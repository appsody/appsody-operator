...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileAppsodyApplication{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileAppsodyApplication) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set AppsodyApplication instance as the owner and controller
...
func newPodForCR(cr *appsodyv1alpha1.AppsodyApplication) *corev1.Pod {
