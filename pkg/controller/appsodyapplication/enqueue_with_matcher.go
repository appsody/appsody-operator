...
type EnqueueRequestsForCustomIndexField struct {
	handler.Funcs
	Matcher func(metav1.Object) ([]appsodyv1beta1.AppsodyApplication, error)
}
...
func CreateImageStreamMatcher(clnt client.Client, watchNamespaces []string) func(metav1.Object) ([]appsodyv1beta1.AppsodyApplication, error) {
	matcher := func(imageStreamTag metav1.Object) ([]appsodyv1beta1.AppsodyApplication, error) {
...
func CreateBindingSecretMatcher(clnt client.Client) func(metav1.Object) ([]appsodyv1beta1.AppsodyApplication, error) {
	matcher := func(secret metav1.Object) ([]appsodyv1beta1.AppsodyApplication, error) {
		apps := []appsodyv1beta1.AppsodyApplication{}
